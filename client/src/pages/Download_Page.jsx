        ...
        ********************************/
        ...
        const DownloadNow=(e,WhatChaptersToDownload)=>{
            ...
            try{
                ...
                fetch(process.env.REACT_APP_Local_Server_IP+":5001/m/StartDownloadChapters", {
                                method: "POST",
                                credentials: "include",
                                headers: {
                            ...
                            .then((resObject) => {
                             ...
                             if(WhatChaptersToDownload.length<=10){
                                    setTimeout(() =>{
                                        setLinkForManga(process.env.REACT_APP_Local_Server_IP+":5001/m/GetDownloadChapters/"+resObject)
                                    },15*1000)
                                }
