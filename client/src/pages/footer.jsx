					...
					<div className="row">
						<div className="col-lg-3">
							<div className="footer__logo">
								<a href={process.env.REACT_APP_Local_Server_IP}>
									{
									value ? 
						...
						<div className="col-lg-6">
							<div className="footer__nav">
								<ul>
									<li className="active"><a href={process.env.REACT_APP_Local_Server_IP}>Homepage</a></li>
									<li><a href='#' id='scrollToTopButton'>Categories</a></li>
									<li><a href={process.env.REACT_APP_Local_Server_IP +'blog'}>Our Blog</a></li>
									<li><a href={process.env.REACT_APP_Local_Server_IP +'contacts'} >Contacts</a></li>
								</ul>
							</div>
						</div>
						<div className="col-lg-3">
