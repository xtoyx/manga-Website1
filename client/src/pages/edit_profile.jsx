...
function Edit_Profile({ data2 }) {
    ...
    */
    ...
    function checkingConfrim_Passwordwithmainone_others(){
        fetch(process.env.REACT_APP_Local_Server_IP +":5000/auth/checkpass", {
            method: 'POST',
            credentials: "include",
            headers: {
    ...
    function checkingConfrim_Passwordwithmainone() {
        fetch(process.env.REACT_APP_Local_Server_IP +":5000/api/checkpass", {
            method: 'POST',
            credentials: "include",
            headers: {
                Accept: "application/json",
    ...
    async function EditUser_webiste() {
        if(unlocked) {
            const response = await fetch(process.env.REACT_APP_Local_Server_IP+':5000/api/update', {
                method: 'POST',
                credentials: "include",
                headers: {
                    Accept: "application/json",
            ...
            if(src !=''){
                try {
                    await fetch(process.env.REACT_APP_Local_Server_IP +':5000/api/upload/photo', {
                        method: 'POST',
                        credentials: "include",
    ...
    async function EditUser_others() {
        if(unlocked) {
            const response = await fetch(process.env.REACT_APP_Local_Server_IP +':5000/auth/update', {
                method: 'POST',
                credentials: "include",
                headers: {
                    Accept: "application/json",
            ...
            if(src !=''){
                try {
                    await fetch(process.env.REACT_APP_Local_Server_IP +':5000/auth/upload/photo', {
                        method: 'POST',
                        credentials: "include",
                        body: JSON.stringify({ data: src , _id:data2.User._id,
                        }),
