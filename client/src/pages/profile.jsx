...
const Profile = ({ data }) => {
    ...
    */
    async function VerifyMailSend (event) {
        ...
        try {
            const response = await fetch(process.env.REACT_APP_Local_Server_IP +':5000/api/send_mail', {
                method: 'POST',
                headers: {
    ...
    const Enablepopup =async (e)=>{
        ...
        setButtonPopup(true);
        try {
            const response = await fetch(+':5000/api/send_mail', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Access-Control-Allow-Origin':'*',
    ...
    const SumbitChangeEmailCode=async ( e )=>{
        ...
        if(User.source ==='website'){
            try {
                const response = await fetch(process.env.REACT_APP_Local_Server_IP +':5000/api/CheckForCodeEmail', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'Access-Control-Allow-Origin':'*',
            ...
            try {
                const response = await fetch(process.env.REACT_APP_Local_Server_IP +':5000/auth/CheckForCodeEmail', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'Access-Control-Allow-Origin':'*',
    ...
    const ChangeEmailNow=async (e)=>{
        ...
        if(User.source ==='website'){
            try {
                const response = await fetch(process.env.REACT_APP_Local_Server_IP +':5000/api/ChangeEmail', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'Access-Control-Allow-Origin':'*',
            ...
            try {
                const response = await fetch(process.env.REACT_APP_Local_Server_IP +':5000/auth/ChangeEmail', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'Access-Control-Allow-Origin':'*',
