    ...
    */
    ...
    const FollowThisPerson=async (e)=>{
       ...
       if(data.User && data.isloggedin.isloggedin &&data.User.name!==Name){
            if(data.User.source === 'google'){
                try{
                    await fetch(process.env.REACT_APP_Local_Server_IP+":5000/auth/followthisuser", {
                                    method: "POST",
                                    credentials: "include",
                                    headers: {
                ...
                try{
                    await fetch(process.env.REACT_APP_Local_Server_IP+":5000/api/followthisuser", {
                                        method: "POST",
                                        credentials: "include",
                                        headers: {
                                            Accept: "application/json",
    ...
    const RemoveFollowThisPerson=async (e)=>{
        ...
        if(data.User && data.isloggedin.isloggedin &&data.User.name!==Name){
            if(data.User.source === 'google'){
                try{
                    await fetch(process.env.REACT_APP_Local_Server_IP+":5000/auth/Removefollowthisuser", {
                                    method: "POST",
                                    credentials: "include",
                                    headers: {
                                        Accept: "application/json",
                ...
                try{
                    await fetch(process.env.REACT_APP_Local_Server_IP+":5000/api/Removefollowthisuser", {
                                        method: "POST",
                                        credentials: "include",
                                        headers: {
                                            Accept: "application/json",
    ...
    const UnFollowThisPerson=async (e)=>{
        ...
        if(data.User && data.isloggedin.isloggedin &&data.User.name!==Name){
            if(data.User.source === 'google'){
                try{
                    await fetch(process.env.REACT_APP_Local_Server_IP +":5000/auth/unfollowthisuser", {
                                    method: "POST",
                                    credentials: "include",
                                    headers: {
                                        Accept: "application/json",
                ...
                try{
                    await fetch(process.env.REACT_APP_Local_Server_IP+":5000/api/unfollowthisuser", {
                                        method: "POST",
                                        credentials: "include",
                                        headers: {
                                            Accept: "application/json",
    ...
    const RemoveUnFollowThisPerson=async (e)=>{
        ...
        if(data.User && data.isloggedin.isloggedin &&data.User.name!==Name){
            if(data.User.source === 'google'){
                try{
                    await fetch(process.env.REACT_APP_Local_Server_IP+":5000/auth/Removeunfollowthisuser", {
                                    method: "POST",
                                    credentials: "include",
                                    headers: {
                                        Accept: "application/json",
                ...
                try{
                    await fetch(process.env.REACT_APP_Local_Server_IP+":5000/api/Removeunfollowthisuser", {
                                        method: "POST",
                                        credentials: "include",
                                        headers: {
                                            Accept: "application/json",
    ...
    const SwitchShowMangasLiked=(e)=>{
        ...
        try{
            User.MangaLiked.map(async (value,index)=>{
                await fetch(process.env.REACT_APP_Local_Server_IP+":5001/m/findbyname", {
                                    method: "POST",
                                    credentials: "include",
                                    headers: {
                                        Accept: "application/json",
    ...
    const SwitchShowComments=(e)=>{
        ...
        try{
            User.Like.map(async (value,index)=>{
                await fetch(process.env.REACT_APP_Local_Server_IP+":5001/comments/findbyid", {
                                    method: "POST",
                                    credentials: "include",
                                    headers: {
                                        Accept: "application/json",
        ...
        try{
            if(User.source ==='google') {
                User.Following.map(async (value,index)=>{
                    await fetch(process.env.REACT_APP_Local_Server_IP+":5000/auth/finduser", {
                                    method: "POST",
                                    credentials: "include",
                                    headers: {
                                        Accept: "application/json",
            ...
            if(User.source === 'website'){
                User.Following.map(async (value,index)=>{
                    await fetch(process.env.REACT_APP_Local_Server_IP+":5000/api/finduser", {
                                    method: "POST",
                                    credentials: "include",
                                    headers: {
                                        Accept: "application/json",
    ...
    useEffect(()=>{
        ...
        try{
            fetch(process.env.REACT_APP_Local_Server_IP+":5000/auth/finduser", {
							method: "POST",
							credentials: "include",
							headers: {
								Accept: "application/json",
