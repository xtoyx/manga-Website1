   ...
   const [AdminExists,setAdminExists]=useState(false);
    ...
    if(StartShowing){  
       ...
       useEffect(()=>{
        ...
        try{
            fetch(process.env.Local_Server_IP +":5001/comments/find", {
							method: "POST",
							credentials: "include",
							headers: {
        ...
        try{
            fetch(process.env.Local_Server_IP +":5001/comments/length", {
							method: "POST",
							credentials: "include",
							headers: {
								Accept: "application/json",
        ...
        const getAdminChecking = () =>{
            try {
                fetch(process.env.Local_Server_IP+":5000/api/CheckForAdminCookie", {
                        method: "GET",
                        credentials: "include",
                        headers: {
                            Accept: "application/json",
        ...
        if(!Waitcoolodwn || !localStorage.getItem('Waiting')){
            if(data.User){
                if(AddComment != '' && AddComment){
                    ...
                    try{
                        fetch(process.env.Local_Server_IP+":5001/comments/add", {
                                        method: "POST",
                                        credentials: "include",
                                        headers: {
                                            Accept: "application/json",
    ...
    const RemoveCommentorReply=(e,username,comment,picture,pages,id)=>{
        ...
        try{
            fetch(process.env.Local_Server_IP +":5001/comments/del", {
                            method: "DELETE",
                            credentials: "include",
                            headers: {
                                Accept: "application/json",
    ...
    const EditCommentNow=(e,username,comment,picture
        ...
        if(EditActive){
            try{
                fetch(process.env.Local_Server_IP +":5001/comments/edit", {
                                method: "POST",
                                credentials: "include",
                                headers: {
                                    Accept: "application/json",
    ...
    /*************/
       ...
       const FollowThisManga=(e)=>{
        ...
        if(FollowingManga){
            if(data.isloggedin.isloggedin){
                if(data.User.source == 'google'){
                    ...
                    try{
                        fetch(process.env.Local_Server_IP+":5000/auth/AddFollow", {
                                        method: "POST",
                                        credentials: "include",
                                        headers: {
                                            Accept: "application/json",
                ...
                if(data.User.source == 'website'){
                    //fetch a post send data with name manga ,username And Id
                    try{
                        fetch(process.env.Local_Server_IP+":5000/api/AddFollow", {
                                        method: "POST",
                                        credentials: "include",
                                        headers: {
                                            Accept: "application/json",
         ...
         if(data.isloggedin.isloggedin){
             if(data.User.source == 'google'){
                 //fetch a post send data with name manga ,username And Id
                 try{
                     fetch(process.env.Local_Server_IP +":5000/auth/RemoveFollow", {
                                     method: "POST",
                                     credentials: "include",
                                     headers: {
                                         Accept: "application/json",
             ...
             if(data.User.source == 'website'){
                 //fetch a post send data with name manga ,username And Id
                 try{
                     fetch(process.env.Local_Server_IP+":5000/api/RemoveFollow", {
                                     method: "POST",
                                     credentials: "include",
                                     headers: {
                                         Accept: "application/json",
        ...
        e.preventDefault();
        try{
            fetch(process.env.Local_Server_IP +":5001/m/Viewup", {
                            method: "POST",
                            credentials: "include",
                            headers: {
                                Accept: "application/json",
        ...
        const AddLikeForComment=async (e,id)=>{
            ...
            if(data.isloggedin.isloggedin){
                if(!LocationCheckLike.includes(id)){
                    try{
                        await fetch(process.env.Local_Server_IP +":5000/auth/AddLike", {
                                        method: "POST",
                                        credentials: "include",
                                        headers: {
                                            Accept: "application/json",
                        ...
                        await fetch(process.env.Local_Server_IP+":5001/comments/AddLike", {
                                            method: "POST",
                                            credentials: "include",
                                            headers: {
                                                Accept: "application/json",
                ...
                if(LocationCheckDislike.includes(id)){
                    try{
                        await fetch(process.env.Local_Server_IP+":5000/auth/RemoveDislike", {
                                        method: "POST",
                                        credentials: "include",
                                        headers: {
                                            Accept: "application/json",
                        ...
                        await fetch(process.env.Local_Server_IP +":5001/comments/ReDislikeAddLike", {
                                                method: "POST",
                                                credentials: "include",
                                                headers: {
                                                    Accept: "application/json",
        ...
        const RemoveLikeForComment=async (e,id)=>{
            ...
            if(data.isloggedin.isloggedin){
                if(LocationCheckLike.includes(id)){
                    try{
                        await fetch(process.env.Local_Server_IP+":5000/auth/RemoveLike", {
                                        method: "POST",
                                        credentials: "include",
                                        headers: {
                                            Accept: "application/json",
                                ...
                                await  fetch(process.env.Local_Server_IP+":5001/comments/ReduceLike", {
                                            method: "POST",
                                            credentials: "include",
                                            headers: {
                                                Accept: "application/json",
        ...
        const AddDisLikeForComment=async (e,id)=>{
            ...
            if(data.isloggedin.isloggedin){
                if(!LocationCheckDislike.includes(id)){
                    try{
                      await  fetch(process.env.Local_Server_IP+":5000/auth/AddDislike", {
                                        method: "POST",
                                        credentials: "include",
                                        headers: {
                                            Accept: "application/json",
                    ...
                    await  fetch(process.env.Local_Server_IP+":5001/comments/AddDislike", {
                                            method: "POST",
                                            credentials: "include",
                                            headers: {
                                                Accept: "application/json",
                ...
                if(LocationCheckLike.includes(id)){
                    try{
                        ...
                        await fetch(process.env.Local_Server_IP +":5001/comments/ReLikeAddDislike", {
                                                method: "POST",
                                                credentials: "include",
                                                headers: {
                                                    Accept: "application/json",
            ...
            if(data.isloggedin.isloggedin){
                if(LocationCheckDislike.includes(id)){
                    try{
                        ...
                        await fetch(process.env.Local_Server_IP+":5001/comments/ReduceDislike", {
                                            method: "POST",
                                            credentials: "include",
                                            headers: {
                                                Accept: "application/json",
