...
if(StartShowing && data.Mangas){
    clearTimeout(t);
    if(Trending === null){
        setTrending(data.Mangas.sort((a,b)=> parseFloat(b.Rating.length)-parseFloat(a.Rating.length)));
    }
    if(Liked_by_TheCreator ===null){
        var IneedHelp=[]
            try{
                fetch(process.env.REACT_APP_Local_Server_IP+":5001/MangaLikedByAdmin/", {
                                            method: "GET",
                                            credentials: "include",
                                            headers: {
                                        ...
                                        .then((resObject) => {
                                            ...
                                            resObject[0].Liked.map((value,index)=>{
                                                fetch(process.env.REACT_APP_Local_Server_IP+":5001/m/findbyid", {
                                                    method: "POST",
                                                    credentials: "include",
                                                    headers: {
                                                        Accept: "application/json",
                ...
                <div className="col-lg-4 col-md-6 col-sm-8">
                    <div className="product__sidebar">
                        <div className="product__sidebar__view">
                            ...
                            {StartShowing &&Liked_by_TheCreator ?
