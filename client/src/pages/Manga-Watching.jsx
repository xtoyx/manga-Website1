...
function Manga_Watching({data}) {
    ...
    */
    ...
    useEffect(()=>{
        ...
        try{
            fetch( process.env.REACT_APP_Local_Server_IP +":5001/comments/find", {
							method: "POST",
							credentials: "include",
							headers: {
        ...
        if(!Waitcoolodwn || !localStorage.getItem('Waiting')){
            if(data.User){
                if(AddComment != '' && AddComment){
                    ...
                    try{
                        fetch(process.env.REACT_APP_Local_Server_IP+":5001/comments/add", {
                                        method: "POST",
                                        credentials: "include",
                                        headers: {
                                            Accept: "application/json",
    ...
    const RemoveCommentorReply=(e,username,comment,picture,pages,id)=>{
        ...
        try{
            fetch(process.env.REACT_APP_Local_Server_IP+":5001/comments/del", {
                            method: "DELETE",
                            credentials: "include",
                            headers: {
                                Accept: "application/json",
    ...
    const EditCommentNow=(e,username,comment,picture
        ...
        if(EditActive){
            try{
                fetch(process.env.REACT_APP_Local_Server_IP +":5001/comments/edit", {
                                method: "POST",
                                credentials: "include",
                                headers: {
                                    Accept: "application/json",
